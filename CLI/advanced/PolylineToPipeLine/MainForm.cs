...
namespace PolylineToPipeLine
{
    public partial class MainForm : Form
    {
        ...
        private IPropertySet param = null;
        private IParametricModelling paraModel = new ParametricModelling();
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
...

            {
                ...
                this.helpProvider1.HelpNamespace = "PolygonToBuilding.html";
            }
            ...
            // 可视化Polygon类型FeatureLayer
            {
                ...
                FeatureLayerVisualize(ci, true, "Polyline");
            }
        ...
        private void btnSelDifCol_Click(object sender, EventArgs e)
        {
            this.colorDialog1.Color = Color.FromArgb(Convert.ToInt32(DifColorBox.Text, 16));
            if (this.colorDialog1.ShowDialog() == DialogResult.OK)
            {
                int a = this.trackBarOpacity1.Value;
                uint olec = (uint)(a << 24 | this.colorDialog1.Color.R << 16 | this.colorDialog1.Color.G << 8 | this.colorDialog1.Color.B);
                this.DifColorBox.Text = olec.ToString("X");
                DifColorBox.BackColor = this.colorDialog1.Color;
            }
        }

        private void btnSelSpeCol_Click(object sender, EventArgs e)
        {
            this.colorDialog1.Color = Color.FromArgb(Convert.ToInt32(SpeColorBox.Text, 16)); 
            if (this.colorDialog1.ShowDialog() == DialogResult.OK)
            {
                int a = this.trackBarOpacity2.Value;
                uint olec = (uint)(a << 24 | this.colorDialog1.Color.R << 16 | this.colorDialog1.Color.G << 8 | this.colorDialog1.Color.B);
                this.SpeColorBox.Text = olec.ToString("X");
                SpeColorBox.BackColor = this.colorDialog1.Color;
            }
        }
